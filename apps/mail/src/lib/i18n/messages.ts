...
const messages: Catalogs = {
  en: {
    ...
    "ml.failed.launch":
      "This window could not find out which message it was asked to open, so it opened none: {$reason}",
  ...
  de: {
    ...
    "ml.failed.launch":
      "Dieses Fenster konnte nicht herausfinden, welche Nachricht es öffnen sollte, deshalb hat es keine geöffnet: {$reason}",
