...
const messages: Catalogs = {
  en: {
    ...
    "ml.menu.needsMessage": "{$action} needs a message.",
    "ml.menu.needsOne": "{$action} works on one message.",
    "ml.menu.go": "Go",
    ...
    "ml.mailboxUnreadable": "The mailbox cannot be read.",
    "ml.retry": "Try again",
    ...
    "ml.delete": "Delete",
    "ml.putBack": "Put back",
    "ml.deletePermanently.title": "Delete \u201c{$subject}\u201d permanently?",
    "ml.deletePermanently.titleN": ".input {$n :number}\n.match $n\none {{Delete one message permanently?}}\n* {{Delete {$n} messages permanently?}}",
    "ml.deletePermanently.body": "The file is removed from this machine. You cannot undo this.",
    "ml.deletePermanently.confirm": "Delete permanently",
  ...
  de: {
    ...
    "ml.failed.other": "Diese Nachricht konnte nicht gelesen werden. Die Einzelheiten stehen im Protokoll.",
    "ml.from": "Von",
    "ml.subject": "Betreff",
    "ml.date": "Datum",
    "ml.to": "An",
    ...
    "ml.attach.failed.unreadable": "Die Nachrichtendatei konnte nicht gelesen werden. {$why}",
    ...
    "ml.menu.needsMessage": "{$action} braucht eine Nachricht.",
    "ml.menu.needsOne": "{$action} geht mit einer Nachricht.",
    "ml.menu.go": "Gehe zu",
    ...
    "ml.mailboxUnreadable": "Das Postfach kann nicht gelesen werden.",
    "ml.retry": "Erneut versuchen",
    ...
    "ml.delete": "Löschen",
    "ml.putBack": "Zurücklegen",
    "ml.deletePermanently.title": "\u201e{$subject}\u201c endgültig löschen?",
    "ml.deletePermanently.titleN": ".input {$n :number}\n.match $n\none {{Eine Nachricht endgültig löschen?}}\n* {{{$n} Nachrichten endgültig löschen?}}",
    "ml.deletePermanently.body": "Die Datei wird von diesem Rechner entfernt. Das lässt sich nicht rückgängig machen.",
    "ml.deletePermanently.confirm": "Endgültig löschen",
