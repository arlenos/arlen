...
const messages: Catalogs = {
  en: {
    ...
    "ml.menu.go": "Go",
    "ml.sample": "Example mailbox, no account is connected.",
    "ml.unconnected": "No account is connected.",
  ...
  de: {
    ...
    "ml.menu.go": "Gehe zu",
    "ml.sample": "Beispiel-Postfach, kein Konto verbunden.",
    "ml.unconnected": "Kein Konto verbunden.",
