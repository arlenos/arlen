...
const messages: Catalogs = {
  en: {
    ...
    "ml.menu.needsMessage": "Select a message first.",
    "ml.menu.needsOne": "Reply and forward work on one message at a time.",
    "ml.menu.go": "Go",
    ...
    "ml.delete": "Delete",
    "ml.putBack": "Put back",
    "ml.deleteForever.title": "Delete \u201c{$subject}\u201d for good?",
    "ml.deleteForever.titleN": ".input {$n :number}\n.match $n\none {{Delete one message for good?}}\n* {{Delete {$n} messages for good?}}",
    "ml.deleteForever.body": "The file is removed from this machine. You cannot undo this.",
    "ml.deleteForever.confirm": "Delete for good",
  ...
  de: {
    ...
    "ml.menu.needsMessage": "Wähle zuerst eine Nachricht aus.",
    "ml.menu.needsOne": "Antworten und Weiterleiten gehen mit einer Nachricht auf einmal.",
    "ml.menu.go": "Gehe zu",
    ...
    "ml.deleteForever.title": "\u201e{$subject}\u201c endgültig löschen?",
    "ml.deleteForever.titleN": ".input {$n :number}\n.match $n\none {{Eine Nachricht endgültig löschen?}}\n* {{{$n} Nachrichten endgültig löschen?}}",
    "ml.deleteForever.body": "Die Datei wird von diesem Rechner entfernt. Das lässt sich nicht rückgängig machen.",
    "ml.deleteForever.confirm": "Endgültig löschen",
