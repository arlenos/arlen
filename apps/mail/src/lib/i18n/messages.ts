...
const messages: Catalogs = {
  en: {
    ...
    "ml.failed.launch": "This window could not find out which message it was asked to open.",
    ...
    "ml.menu.message": "Message",
    "ml.menu.go": "Go",
    "ml.sample": "Example mailbox, not this machine's mail.",
    "ml.noMailbox": "There is no mailbox at {$path}.",
    "ml.noMailboxHere": "There is no mailbox on this machine.",
    "ml.mailboxUnreadable": "The mailbox could not be read.",
    "ml.loading": "Reading your mail.",
    ...
    "ml.threadCount": ".input {$n :number}\n.match $n\none {{1 message in this conversation}}\n*   {{{$n} messages in this conversation}}",
    "ml.openedFile": "Opened file",
    "ml.openFailed": "This message did not open. It is still there; nothing was changed.",
    "ml.err.notMoved": "That message did not move.",
    "ml.err.notDeleted": "That message was not deleted.",
    "ml.err.notDrafted": "That draft was not saved.",
    "ml.noSubject": "(no subject)",
    "ml.noSender": "(no sender)",
    "ml.reply": "Reply",
    "ml.forward": "Forward",
    "ml.archive": "Archive",
    "ml.delete": "Delete",
    ...
    "ml.compose.cantSend": "Sending is not connected to an account yet.",
    "ml.compose.saveToDrafts": "Save to Drafts",
  ...
  de: {
    ...
    "ml.menu.message": "Nachricht",
    "ml.menu.go": "Gehe zu",
    "ml.sample": "Beispiel-Postfach, nicht die Mail dieses Rechners.",
    "ml.noMailbox": "Unter {$path} liegt kein Postfach.",
    "ml.noMailboxHere": "Auf diesem Rechner liegt kein Postfach.",
    "ml.mailboxUnreadable": "Das Postfach ließ sich nicht lesen.",
    "ml.loading": "Liest deine Nachrichten.",
    ...
    "ml.threadCount": ".input {$n :number}\n.match $n\none {{1 Nachricht in dieser Unterhaltung}}\n*   {{{$n} Nachrichten in dieser Unterhaltung}}",
    "ml.openedFile": "Geöffnete Datei",
    "ml.openFailed": "Diese Nachricht hat sich nicht geöffnet. Sie ist weiterhin da, geändert wurde nichts.",
    "ml.err.notMoved": "Diese Nachricht wurde nicht verschoben.",
    "ml.err.notDeleted": "Diese Nachricht wurde nicht gelöscht.",
    "ml.err.notDrafted": "Dieser Entwurf wurde nicht gespeichert.",
    "ml.noSubject": "(kein Betreff)",
    "ml.noSender": "(kein Absender)",
    "ml.reply": "Antworten",
    ...
    "ml.compose.cantSend": "Senden ist noch mit keinem Konto verbunden.",
    "ml.compose.saveToDrafts": "In Entwürfen speichern",
