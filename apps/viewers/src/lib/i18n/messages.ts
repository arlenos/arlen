...
const messages: Catalogs = {
  en: {
    ...
    "v.trash.noTrashHere": "This drive cannot hold a trash.",
    ...
    "v.print.noBus": "The print dialog could not be opened.",
    ...
    "v.restore.nameTaken": "Something is using that name again.",
    "v.restore.unsupported": "This drive cannot put a file back without risking whatever is there now.",
    ...
    "v.couldNotAsk": "The viewer could not find out which file it was asked to open.",
  ...
  de: {
    ...
    "v.trash.noTrashHere": "Dieses Laufwerk kann keinen Papierkorb führen.",
    ...
    "v.couldNotAsk": "Der Betrachter konnte nicht herausfinden, welche Datei er öffnen sollte.",
