...
const messages: Catalogs = {
  en: {
    ...
    "sh.undo.take.restore-from-trash": "Restore",
    "sh.undo.take.restore-value": "Restore previous",
  ...
  de: {
    ...
    "sh.undo.take.restore-from-trash": "Wiederherstellen",
    "sh.undo.take.restore-value": "Zur\u00fccksetzen",
