...
const messages: Catalogs = {
  en: {
    ...
    "sh.net.stateUnknown": "Could not read the network state.",
    ...
    "sh.qs.layoutUnreadable": "Could not read your Quick Settings layout, so the default tiles are shown.",
    ...
    "sh.bt.stateUnknown": "Could not read the Bluetooth state.",
  ...
  de: {
    ...
    "sh.net.stateUnknown": "Der Netzwerkstatus konnte nicht gelesen werden.",
    ...
    "sh.bt.stateUnknown": "Der Bluetooth-Status konnte nicht gelesen werden.",
