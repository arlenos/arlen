...
const messages: Catalogs = {
  en: {
    ...
    "sh.wp.agentUnreachable": "The agent is not reachable right now.",
    "sh.wp.agentOff": "AI is off. The agent reads and answers nothing.",
  ...
  de: {
    ...
    "sh.wp.agentUnreachable": "Der Assistent ist gerade nicht erreichbar.",
    "sh.wp.agentOff": "KI ist aus. Der Assistent liest und beantwortet nichts.",
