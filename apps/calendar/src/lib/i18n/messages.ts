...
const messages: Catalogs = {
  en: {
    ...
    "cal.series.notYet": "Editing a repeating series is not built yet, so this event stays as its file wrote it.",
  ...
  de: {
    ...
    "cal.series.notYet": "Serien bearbeiten ist noch nicht gebaut, dieser Termin bleibt also wie seine Datei ihn schreibt.",
