...
const messages: Catalogs = {
  en: {
    ...
    "mt.unavailable": "Cannot read your meetings right now.",
    ...
    "mt.noteUnavailable": "Cannot read this meeting right now.",
  ...
  de: {
    ...
    "mt.unavailable": "Deine Besprechungen sind gerade nicht lesbar.",
    ...
    "mt.noteUnavailable": "Diese Besprechung ist gerade nicht lesbar.",
