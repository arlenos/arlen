...
const messages: Catalogs = {
  en: {
    ...
    "mt.stop": "Stop",
    "mt.consent": "Recording locally. Nothing joins the call, nothing leaves this machine.",
  ...
  de: {
    ...
    "mt.stop": "Stopp",
    "mt.consent": "Nimmt lokal auf. Nichts tritt dem Call bei, nichts verlässt diesen Rechner.",
