...
const messages: Catalogs = {
  en: {
    ...
    "mt.unavailable": "Cannot read your meetings right now, so none are shown.",
    "mt.unavailable.why": "Cannot read your meetings right now, so none are shown: {$reason}",
    "mt.unavailable.absent": "The meetings service is not running on this machine, so none can be shown.",
    "mt.unavailable.refused": "This app was not allowed to read your meetings, so none are shown.",
  ...
  de: {
    ...
    "mt.unavailable": "Deine Besprechungen sind gerade nicht lesbar, deshalb wird keine gezeigt.",
    "mt.unavailable.why": "Deine Besprechungen sind gerade nicht lesbar, deshalb wird keine gezeigt: {$reason}",
    "mt.unavailable.absent": "Der Besprechungsdienst läuft auf diesem Rechner nicht, es lässt sich also keine anzeigen.",
    "mt.unavailable.refused": "Diese App durfte deine Besprechungen nicht lesen, es wird also keine gezeigt.",
