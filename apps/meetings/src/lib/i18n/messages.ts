...
const messages: Catalogs = {
  en: {
    ...
    "mt.nav.aria": "Meetings",
    "mt.title": "Meetings",
    "mt.start": "Start a meeting",
    "mt.newMeeting": "New meeting",
    "mt.pickHint": "Pick a meeting from the list or start a new one.",
    "mt.empty": "No meetings. Start one to capture it on this device.",
    "mt.emptyShort": "No meetings.",
    "mt.open": "Open in editor",
    "mt.sample.list": "Example meetings, not your history.",
    "mt.unavailable": "Your meetings cannot be read.",
    "mt.unavailable.noAnswer": "The meetings service did not answer.",
    "mt.unavailable.absent": "The meetings service is not running on this machine.",
    "mt.unavailable.refused": "This app was not allowed to read your meetings.",
    "mt.noteUnavailable": "This meeting cannot be read.",
    "mt.noteMissing": "There is no note for this meeting.",
    ...
    "mt.menu.meeting": "Meeting",
    "mt.menu.stop": "Stop recording",
    "mt.menu.view": "View",
    ...
    "mt.notes.placeholder.noCapture": "Jot what matters. Nothing is being recorded, so this is all there will be.",
  ...
  de: {
    ...
    "mt.empty": "Keine Besprechungen. Starte eine, um sie auf diesem Gerät aufzunehmen.",
    "mt.emptyShort": "Keine Besprechungen.",
    "mt.open": "Im Editor öffnen",
    "mt.sample.list": "Beispiel-Meetings, nicht dein Verlauf.",
    "mt.unavailable": "Deine Besprechungen können nicht gelesen werden.",
    "mt.unavailable.noAnswer": "Der Besprechungsdienst hat nicht geantwortet.",
    "mt.unavailable.absent": "Der Besprechungsdienst läuft auf diesem Rechner nicht.",
    "mt.unavailable.refused": "Diese App durfte deine Besprechungen nicht lesen.",
    "mt.noteUnavailable": "Diese Besprechung kann nicht gelesen werden.",
    "mt.noteMissing": "Zu dieser Besprechung gibt es keine Notiz.",
    ...
    "mt.menu.meeting": "Meeting",
    "mt.menu.stop": "Aufnahme stoppen",
    "mt.menu.view": "Ansicht",
    ...
    "mt.notes.placeholder.noCapture": "Notiere das Wichtige. Es wird nichts aufgenommen, mehr als das hier wird es also nicht.",
