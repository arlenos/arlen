...
const messages: Catalogs = {
  en: {
    ...
    "mt.note.sovereign": "Captured on this device, in your audit log",
    ...
    "mt.capture.sovereign": "On this device, in your audit log",
    "mt.stop": "Stop",
  ...
  de: {
    ...
    "mt.note.sovereign": "Auf diesem Gerät aufgenommen, in deinem Audit-Log",
    ...
    "mt.capture.sovereign": "Auf diesem Gerät, in deinem Audit-Log",
    "mt.stop": "Stopp",
