...
const messages: Catalogs = {
  en: {
    ...
    "mt.unavailable.noAnswer": "The meetings service did not answer, so none are shown.",
  ...
  de: {
    ...
    "mt.unavailable.noAnswer": "Der Besprechungsdienst hat nicht geantwortet, deshalb wird keine gezeigt.",
