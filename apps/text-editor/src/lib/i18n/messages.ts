...
const messages: Catalogs = {
  en: {
    ...
    "te.asOf.now": "Now",
    "te.asOf.unavailable": "Time travel needs recorded history, which is not being written yet.",
  ...
  de: {
    ...
    "te.asOf.now": "Jetzt",
    "te.asOf.unavailable": "Zeitreise braucht aufgezeichnete Historie, die noch nicht geschrieben wird.",
