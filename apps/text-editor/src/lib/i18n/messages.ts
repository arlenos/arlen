...
const messages: Catalogs = {
  en: {
    ...
    "te.asOf.now": "Now",
    "te.asOf.unavailable": "The graph only started recording membership history today, so there is nothing earlier to show.",
  ...
  de: {
    ...
    "te.asOf.now": "Jetzt",
    "te.asOf.unavailable": "Der Graph zeichnet Zugehörigkeits-Historie erst seit heute auf, es gibt also nichts Früheres zu zeigen.",
