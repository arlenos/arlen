...
const messages: Catalogs = {
  en: {
    ...
    "te.save.changedOnDisk": "This file changed on disk since you opened it.",
  ...
  de: {
    ...
    "te.save.changedOnDisk": "Diese Datei wurde seit dem Öffnen auf der Festplatte geändert.",
