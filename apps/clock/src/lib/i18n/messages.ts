...
const messages: Catalogs = {
  en: {
    ...
    "c.tab.world": "World",
    "c.menu.new": "New",
    "c.menu.addTimer": "Add timer",
    "c.menu.addCity": "Add city",
    "c.menu.view": "View",
    "c.sample": "Example alarms and timers, not this machine's.",
  ...
  de: {
    ...
    "c.tab.world": "Welt",
    "c.menu.new": "Neu",
    "c.menu.addTimer": "Timer hinzufügen",
    "c.menu.addCity": "Stadt hinzufügen",
    "c.menu.view": "Ansicht",
    "c.sample": "Beispiel-Wecker und -Timer, nicht die dieses Rechners.",
