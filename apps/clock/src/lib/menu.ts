/// The clock app's global menu in the shell's top-left menu bar (the
  ...
  return [
    {
      label: t("c.menu.new"),
      items: [
        item(t("c.al.add"), "new.alarm"),
        item(t("c.menu.addTimer"), "new.timer"),
        item(t("c.menu.addCity"), "new.city"),
      ],
    },
    {
      label: t("c.menu.view"),
      items: [
        item(t("c.tab.alarms"), "view.alarms"),
        item(t("c.tab.timers"), "view.timers"),
        item(t("c.tab.stopwatch"), "view.stopwatch"),
        item(t("c.tab.world"), "view.world"),
        item(t("c.tab.focus"), "view.focus"),
      ],
    },
  ];
}
