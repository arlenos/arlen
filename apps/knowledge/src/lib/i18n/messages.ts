...
const messages: Catalogs = {
  en: {
    ...
    "k.library.notBuilt": "The library is not built yet, so no source is connected to it.",
    ...
    "k.tl.noService": "The knowledge service is not running, so nothing is being recorded and nothing is shown.",
    ...
    "k.se.projectsUnavailable": "Projects could not be read.",
    "k.se.today": "Today",
    "k.se.week": "This week",
  ...
  de: {
    ...
    "k.library.notBuilt": "Die Bibliothek ist noch nicht gebaut, es ist also keine Quelle angebunden.",
    ...
    "k.tl.noService": "Der Wissensdienst läuft nicht, es wird also nichts aufgezeichnet und nichts angezeigt.",
    ...
    "k.se.projectsUnavailable": "Projekte konnten nicht gelesen werden.",
