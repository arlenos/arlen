...
const messages: Catalogs = {
  en: {
    ...
    "k.empty.library": "No sources bridged in yet. Bridges come from the Store and bring their source with them.",
    ...
    "k.se.noProjects": "No projects detected yet.",
  ...
  de: {
    ...
    "k.empty.library": "Noch keine Quellen eingebunden. Brücken kommen aus dem Store und bringen ihre Quelle mit.",
    "k.detail.title": "Details",
    ...
    "k.se.noProjects": "Noch keine Projekte erkannt.",
