...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::printers::print_job_retry,
            commands::printers::printers_set_default,
            commands::printers::printers_set_options,
            ...
            commands::sentinel::sentinel_get_state,
            commands::sentinel::sentinel_set_detector,
            commands::sentinel::sentinel_set_alerts,
            commands::sentinel::sentinel_set_sensitivity,
            ...
            commands::windows_apps::clear_bottle_caches,
            commands::windows_apps::install_windows_app,
            commands::windows_apps::bottle_programs,
            ...
            commands::windows_apps::bottle_disk_usage,
            ...
            commands::theme::theme_color_overrides,
            commands::theme::theme_system_overrides,
            ...
            commands::theme::theme_toolkit_overrides,
            ...
            commands::app_settings::app_settings_page,
            commands::app_settings::app_settings_write,
            commands::theme::set_theme,
            commands::theme::get_active_theme_id,
            commands::theme::theme_install_file,
            commands::theme::theme_import_scheme,
