...
const messages: Catalogs = {
  en: {
    ...
    "s.noHost": "There is nothing here to capture with, so no picture was taken.",
    ...
    "s.why.noScreencopy": "This desktop does not offer screen capture to apps, so there is no way to take one.",
  ...
  de: {
    ...
    "s.noHost": "Hier ist nichts, womit aufgenommen werden könnte, deshalb wurde kein Bild gemacht.",
    "s.why.noScreencopy": "Diese Arbeitsumgebung bietet Apps keine Bildschirmaufnahme an, es gibt also keinen Weg dorthin.",
