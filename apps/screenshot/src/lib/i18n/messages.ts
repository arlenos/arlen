...
const messages: Catalogs = {
  en: {
    ...
    "s.captureUnavailable": "Could not take a picture of your screen.",
    "s.noHost": "There is nothing here to capture with.",
    ...
    "s.swatch.success": "Green",
    "s.swatch.fg-primary": "Foreground",
    "s.swatch.fg-inverse": "Contrast",
  ...
  de: {
    ...
    "s.swatch.success": "Grün",
    "s.swatch.fg-primary": "Vordergrund",
    "s.swatch.fg-inverse": "Kontrast",
