/// The screenshot app's global menu in the shell's top-left menu bar (the
...
const APP_ID = "dev.arlen.screenshot";
  ...
  return [
    {
      label: t("s.menu.edit"),
      items: [
        item(t("s.undo"), "edit.undo", "Ctrl+Z"),
        item(t("s.redo"), "edit.redo", "Ctrl+Shift+Z"),
        sep(),
        item(t("s.copy"), "edit.copy", "Ctrl+C"),
      ],
    },
  ];
}
