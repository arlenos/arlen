...
const messages: Catalogs = {
  en: {
    ...
    "tm.dp.accessUnknown": "Whether this process uses your camera, microphone or screen is not measured yet.",
    "tm.dp.reachUnknown": "What it can reach comes from its permission profile, which this window does not read yet.",
    ...
    "tm.col.accessUnavailable": "Which processes use the camera, the microphone or the graph is not measured yet",
    "tm.col.cpu": "CPU",
    ...
    "tm.menu.priorityUnavailable": "Priorities cannot be read here.",
    "tm.menu.stop": "Stop",
  ...
  de: {
    ...
    "tm.dp.accessUnknown": "Ob dieser Prozess Kamera, Mikrofon oder Bildschirm nutzt, wird noch nicht gemessen.",
    "tm.dp.reachUnknown": "Worauf er zugreifen kann, steht in seinem Berechtigungsprofil, das dieses Fenster noch nicht liest.",
    ...
    "tm.col.accessUnavailable": "Welche Prozesse Kamera, Mikrofon oder den Graphen nutzen, wird noch nicht gemessen",
    "tm.col.cpu": "CPU",
    ...
    "tm.menu.priorityUnavailable": "Prioritäten können hier nicht gelesen werden.",
