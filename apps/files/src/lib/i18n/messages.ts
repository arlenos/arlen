...
const messages: Catalogs = {
  en: {
    ...
    "f.open.noHandler": "Nothing on this machine is set up to open {$what} files.",
    "f.open.notInstalled": "{$what} is not installed.",
    ...
    "f.place.pictures": "Pictures",
    "f.place.music": "Music",
    "f.place.videos": "Videos",
    ...
    "f.facet.type.image": "Images",
    "f.facet.type.audio": "Audio",
    "f.facet.type.video": "Video",
    "f.facet.type.archive": "Archives",
    "f.facet.type.code": "Code",
    "f.facet.time.day": "Today",
    "f.facet.time.week": "Last 7 days",
    "f.facet.time.month": "Last 30 days",
    "f.facet.time.older": "Older than 30 days",
    "f.asof.now": "Now",
    "f.asof.1d": "1 day ago",
    ...
    "f.col.name": "Name",
    "f.col.size": "Size",
    "f.col.modified": "Modified",
    "f.col.location": "Location",
    "f.col.originalLocation": "Original location",
    "f.col.deleted": "Deleted",
    "f.col.lastAccessed": "Last accessed",
    "f.about.name": "Files",
    ...
    "f.gm.help": "Help",
    "f.gm.newTab": "New tab",
    "f.gm.properties": "Properties",
    "f.gm.closeWindow": "Close Window",
    "f.gm.undo": "Undo",
    "f.gm.selectAll": "Select All",
    "f.gm.refresh": "Refresh",
    "f.gm.sortBy": "Sort By",
    "f.gm.parentFolder": "Parent Folder",
    ...
    "f.op.copying": ".input {$n :number}\n.match $n\none {{Copying {$n} item}}\n* {{Copying {$n} items}}",
    "f.op.moving": ".input {$n :number}\n.match $n\none {{Moving {$n} item}}\n* {{Moving {$n} items}}",
    ...
    "f.prov.sample": "Example history, not this file's real origin.",
    ...
    "f.results.noHostHint": "This window has no backend to search with.",
  ...
  de: {
    ...
    "f.open.noHandler": "Auf diesem Rechner ist nichts eingerichtet, das {$what}-Dateien öffnet.",
    "f.open.notInstalled": "{$what} ist nicht installiert.",
    ...
    "f.facet.type.image": "Bilder",
    "f.facet.type.audio": "Audio",
    "f.facet.type.video": "Video",
    "f.facet.type.archive": "Archive",
    "f.facet.type.code": "Code",
    "f.facet.time.day": "Heute",
    "f.facet.time.week": "Letzte 7 Tage",
    "f.facet.time.month": "Letzte 30 Tage",
    "f.facet.time.older": "Älter als 30 Tage",
    "f.asof.now": "Jetzt",
    "f.asof.1d": "vor 1 Tag",
    ...
    "f.col.name": "Name",
    "f.col.size": "Größe",
    "f.col.modified": "Geändert",
    "f.col.location": "Ort",
    "f.col.originalLocation": "Ursprünglicher Ort",
    "f.col.deleted": "Gelöscht",
    "f.col.lastAccessed": "Zuletzt geöffnet",
    ...
    "f.gm.go": "Gehe zu",
    "f.gm.help": "Hilfe",
    "f.gm.newTab": "Neuer Tab",
    "f.gm.properties": "Eigenschaften",
    "f.gm.closeWindow": "Fenster schließen",
    "f.gm.undo": "Rückgängig",
    "f.gm.selectAll": "Alles auswählen",
    "f.gm.refresh": "Aktualisieren",
    "f.gm.sortBy": "Sortieren nach",
    "f.gm.parentFolder": "Übergeordneter Ordner",
    ...
    "f.op.copying": ".input {$n :number}\n.match $n\none {{{$n} Objekt wird kopiert}}\n* {{{$n} Objekte werden kopiert}}",
    "f.op.moving": ".input {$n :number}\n.match $n\none {{{$n} Objekt wird verschoben}}\n* {{{$n} Objekte werden verschoben}}",
    ...
    "f.results.noHostHint": "Dieses Fenster hat kein Backend, das suchen könnte.",
