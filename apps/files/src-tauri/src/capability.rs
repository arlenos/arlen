//! AI capability context for the file manager's capability
//! indicator (file-manager-ui-plan.md: reused from the harness).
//! Copied from the harness reader so both apps report exactly what
//! the daemon enforces from the same file.
//!
