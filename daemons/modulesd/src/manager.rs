...
fn proto_to_wit_result(
    ...
    WitResult {
        ...
        // Going back INTO the guest, so the keys are not carried: the host has
        // already resolved them on the way out, and handing a module the key it
        // sent adds nothing it does not have.
        title_key: None,
