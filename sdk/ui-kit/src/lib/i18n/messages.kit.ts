...
export const kitMessages: Catalogs = {
  en: {
    ...
    "k.why.permission": "You do not have permission for it.",
    "k.why.readOnly": "That place cannot be written to.",
    "k.why.noSpace": "The disk is full.",
    "k.why.gone": "The file is no longer there.",
    "k.why.notAFile": "That is not a file.",
  ...
  de: {
    ...
    "k.why.permission": "Dir fehlt die Berechtigung dafür.",
    "k.why.readOnly": "Dort kann nichts geschrieben werden.",
    "k.why.noSpace": "Die Platte ist voll.",
    "k.why.gone": "Die Datei ist nicht mehr da.",
    "k.why.notAFile": "Das ist keine Datei.",
