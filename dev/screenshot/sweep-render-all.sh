...
SURFACES=(
  ...
  # asked for.
  "files /|/::[data-place=recent]|/::[data-place=trash]|/_asktest|/_duptest|/_facettest|/_rendertest|/_sidebartest|/_thumbtest|/_thumbtest?view=grid|/_thumbtest?view=miller|/@@files-refuses-op|/@@files-two-tabs"
